// lib/SafePayEscrow.abi.ts
// ABI exported directly from Remix IDE deployment
// Contract: SafePayEscrow

const SafePayEscrowABI = [
  {
    inputs: [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true,  internalType: "address", name: "oldArbiter", type: "address" },
  ...
  },
  {
    ...
    outputs: [{
      components: [
        ...
        { internalType: "enum SafePayEscrow.EscrowStatus", name: "status", type: "uint8" },
      ],
...
export default SafePayEscrowABI;

// ── Convenience: just the createEscrow fragment for ethers.js in the browser ──
// (ethers on the client only needs the functions it calls)
export const CREATE_ESCROW_ABI = [
  {
    inputs: [
      { internalType: "string",  name: "orderId", type: "string"  },
      { internalType: "address", name: "seller",  type: "address" },
